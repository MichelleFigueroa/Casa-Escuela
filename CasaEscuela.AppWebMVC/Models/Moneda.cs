...
namespace CasaEscuela.AppWebMVC.Models
{
    public class Moneda
    {
        ...
        public String ConvertirLetra(String numero, bool mayusculas)
        {
            return Convertir(numero,mayusculas,"",false,"uno");
        }
            public String Convertir(String numero, bool mayusculas, string moneda = "PESOS",bool isLiteralDec=true,string uno="un")
        {
            UNIDADES[1] = uno;
            String literal = "";
